...
def select_io_file(parent):
    ...
    if dialog.exec():
        ...
        #parent.io_data = QPushButton(parent.router.source_data.strip('.csv'))  # - imported IO csv filename
        #parent.io_data.setText(filename)
        parent.io_data.setText(parent.router.source_data.strip('.csv'))
        parent.io_data.setText(parent.router.source_data)
        return filename
    else:
        return False
